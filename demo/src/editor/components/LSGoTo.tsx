...
import { REFERENCE_KIND_LABELS, type ReferenceKind } from "vtlsp/codemirror-lsp/src/extensions/references";
  ...
  return (
    <div className="bg-white">
      <div className="flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">{label} ({locations.length})</h3>
        <button
          type="button"
          onClick={onClose}
