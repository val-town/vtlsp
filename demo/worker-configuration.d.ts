/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 497cac40b0984c144f1bd58fc1c52c19)
// Runtime types generated with workerd@1.20250803.0 2025-05-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: "production";
		COOKIE_DOMAIN: "lsp.val.town";
		VTLSP_DEMO_CONTAINER: DurableObjectNamespace<import("./deploy/main").VTLSPDemoContainer>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "COOKIE_DOMAIN">> {}
}
