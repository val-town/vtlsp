...
export interface LSPRequestMap {
  ...
  "textDocument/documentColor": [LSP.DocumentColorParams, (LSP.ColorInformation)[] | null];
  "textDocument/colorPresentation": [LSP.ColorPresentationParams, (LSP.ColorPresentation)[] | null];
  "textDocument/foldingRange": [LSP.FoldingRangeParams, (LSP.FoldingRange)[] | null | null];
  "workspace/foldingRange/refresh": [any, null | null];
  "textDocument/declaration": [
    LSP.DeclarationParams,
    LSP.Declaration | (LSP.DeclarationLink)[] | null | null,
  ];
  "textDocument/selectionRange": [LSP.SelectionRangeParams, (LSP.SelectionRange)[] | null | null];
  "window/workDoneProgress/create": [LSP.WorkDoneProgressCreateParams, null | null];
  ...
  "textDocument/semanticTokens/full": [LSP.SemanticTokensParams, LSP.SemanticTokens | null | null];
  ...
  "window/showDocument": [LSP.ShowDocumentParams, LSP.ShowDocumentResult | null];
  "textDocument/linkedEditingRange": [
    LSP.LinkedEditingRangeParams,
    LSP.LinkedEditingRanges | null | null,
  ];
  "workspace/willCreateFiles": [LSP.CreateFilesParams, LSP.WorkspaceEdit | null | null];
  "workspace/willRenameFiles": [LSP.RenameFilesParams, LSP.WorkspaceEdit | null | null];
  "workspace/willDeleteFiles": [LSP.DeleteFilesParams, LSP.WorkspaceEdit | null | null];
  ...
  "textDocument/inlineValue": [LSP.InlineValueParams, (LSP.InlineValue)[] | null | null];
  "workspace/inlineValue/refresh": [any, null | null];
  "textDocument/inlayHint": [LSP.InlayHintParams, (LSP.InlayHint)[] | null | null];
  "inlayHint/resolve": [LSP.InlayHint, LSP.InlayHint | null];
  "workspace/inlayHint/refresh": [any, null | null];
  "textDocument/diagnostic": [LSP.DocumentDiagnosticParams, LSP.DocumentDiagnosticReport | null];
  "workspace/diagnostic": [LSP.WorkspaceDiagnosticParams, LSP.WorkspaceDiagnosticReport | null];
  ...
  "window/showMessageRequest": [LSP.ShowMessageRequestParams, LSP.MessageActionItem | null | null];
  ...
  "textDocument/signatureHelp": [LSP.SignatureHelpParams, LSP.SignatureHelp | null | null];
  "textDocument/definition": [
    LSP.DefinitionParams,
    LSP.Definition | (LSP.DefinitionLink)[] | null | null,
  ];
  "textDocument/references": [LSP.ReferenceParams, (LSP.Location)[] | null | null];
  ...
  "textDocument/codeAction": [LSP.CodeActionParams, (LSP.Command | LSP.CodeAction)[] | null | null];
  ...
  "textDocument/documentLink": [LSP.DocumentLinkParams, (LSP.DocumentLink)[] | null | null];
  "documentLink/resolve": [LSP.DocumentLink, LSP.DocumentLink | null];
  "textDocument/formatting": [LSP.DocumentFormattingParams, (LSP.TextEdit)[] | null | null];
  ...
  "textDocument/prepareRename": [LSP.PrepareRenameParams, LSP.PrepareRenameResult | null | null];
  "workspace/executeCommand": [LSP.ExecuteCommandParams, LSP.LSPAny | null | null];
  "workspace/applyEdit": [LSP.ApplyWorkspaceEditParams, LSP.ApplyWorkspaceEditResult | null];
}
